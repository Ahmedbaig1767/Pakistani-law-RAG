...
============================================================
  ...
  This script:
    1. Cleans text format (normalization)
    2. Scales word count values

  Key fix:
    - Keeps dots (.) so section numbers like "379." stay intact
    - Keeps hyphens (-) for compound legal terms
    - Lowercases all text for consistent embeddings
============================================================
"""
...
if __name__ == "__main__":
>>>>>>> abf26ca4aa28f28a59497287db66ea7932710fb6
    normalize_all()